...
const Sidebar = () => {
    return (
        <section className='fixed w-fit h-[100vh] py-10 pr-8 flex flex-col justify-between items-center gap-4 bg-[#131313]'>
            <nav className='flex flex-col gap-2 px-6'>
                <Image alt="" src={logo} width={160} className='pb-4' />
                <Link href={'/dashboard'}>
                    <div className='px-4 py-3 flex gap-3 items-center  text-white font-medium bg-[#131313] hover:bg-[#303030] transition transition-800 cursor-pointer rounded-lg'>
